...
const socialLinks = [
  {
    href: 'mailto:contact@isethan.me',
    label: 'Email',
    icon: (
...
const Profile: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center text-center mb-12">
      ...
      <div
        className="relative mb-5 rounded-full p-1"
        style={{
      ...
      >
        <div
          ...
          style={{
            boxShadow: '0 0 0 6px var(--bg), 0 0 0 7px var(--glass-border)',
          }}
        >
          <Image
      ...
      {/* Name + parenthetical */}
      <h1 className="mb-1 flex items-baseline justify-center gap-2 flex-wrap">
        <span
          style={{
            fontSize: '40px',
            fontWeight: 700,
        ...
        {socialLinks.map((link) => (
          <a
            ...
            style={{
              ...
              color: hoveredIcon === link.label ? 'var(--accent)' : 'var(--ink-3)',
              transform: hoveredIcon === link.label ? 'translateY(-2px)' : 'translateY(0)',
            }}
